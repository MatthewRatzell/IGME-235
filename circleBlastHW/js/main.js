...
//preage setting up gameover label `Your final score:${score}`
...
function gameLoop(){
    ...
    //keeping ship on screen with clamp
    let w2 = ship.width/2;
...
function createExplosion(x,y,frameWidth,frameHeight){
    ...
    expl.x = x-w2;//explosion at center of circle
    expl.y = y - h2;
